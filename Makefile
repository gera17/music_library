...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/georgii/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
PM_TO_BLIB = lib/Local/MusicLibrary.pm \
	...
	lib/Local/MusicLibrary1.pm \
	blib/lib/Local/MusicLibrary1.pm \
	lib/Local/args.pm \
	blib/lib/Local/args.pm \
	lib/Local/mlib.pm \
	blib/lib/Local/mlib.pm \
	lib/Local/mlib_cmp.pm \
	blib/lib/Local/mlib_cmp.pm \
	lib/Local/parse.pm \
	blib/lib/Local/parse.pm \
	lib/Local/tab.pm \
	blib/lib/Local/tab.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) -u \
	  ...
	  lib/Local/MusicLibrary1.pm $(INST_MAN3DIR)/Local::MusicLibrary1.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  lib/Local/MusicLibrary1.pm blib/lib/Local/MusicLibrary1.pm \
	  lib/Local/args.pm blib/lib/Local/args.pm \
	  lib/Local/mlib.pm blib/lib/Local/mlib.pm \
	  lib/Local/mlib_cmp.pm blib/lib/Local/mlib_cmp.pm \
	  lib/Local/parse.pm blib/lib/Local/parse.pm \
	  lib/Local/tab.pm blib/lib/Local/tab.pm 
